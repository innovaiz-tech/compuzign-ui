...
const FEATURE_CARDS = [
  {
    ...
    description: "24/7 support that keeps your operations running.",
    icon: (
  ...
  },
  {
    ...
    description: "Certified engineers ready to resolve issues fast.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-primary">
  ...
  },
  {
    ...
    description: "Pay for what you need, scale when you grow.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-primary">
  ...
  },
  {
    ...
    description: "Track performance, uptime, and satisfaction with ease.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-primary">
  ...
  {
    title: "CompuZign",
    description: "The Premier Support System for Leading Agencies. Your tech, our responsibility.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-primary">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {FEATURE_CARDS.map((card, index) => (
              <div
                key={index}
                className={`bg-white rounded-lg shadow-md p-6 transition-transform hover:scale-105 hover:shadow-lg feature-card ${card.colSpan}`}
                style={{ opacity: 0 }}
              >
          ...
          <div className="text-center mb-12">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 text-sm sm:text-base animate-item">
                CompuZign’s Support-as-a-Service covers every angle of your IT needs with precision and care.
              </p>
            </div>
          </div>
